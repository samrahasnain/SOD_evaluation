...
class Eval_thread():
    ...
    def run(self):
        ...
        self.LOG('{} dataset  get {:.4f} mae, {:.4f} max-fmeasure, {:.4f} max-Emeasure, {:.4f} S-measure..\n'.format(self.dataset,  mae, max_f, max_e, s))
        return '[cost:{:.4f}s]{} dataset  get {:.4f} mae, {:.4f} max-fmeasure, {:.4f} max-Emeasure, {:.4f} S-measure..'.format(time.time()-start_time, self.dataset, mae, max_f, max_e, s)
    def Eval_mae(self):
        print('eval[MAE]:{} dataset .'.format(self.dataset))
